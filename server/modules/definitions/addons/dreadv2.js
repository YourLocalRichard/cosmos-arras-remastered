...
module.exports = ({ Class }) => {
	...
	Class.converterTurretOfficialV2 = {
		PARENT: ["autoTankGun"],
		GUNS: [
			{
				POSITION: [20, 9, 1, 0, 0, 0, 0],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.basic, g.auto, {reload: 2.5, health: 1.2, damage: 0.75, speed: 1.3}]),
					TYPE: "bullet",
				},
			},
		],
	}
	Class.converterOfficialV2 = {
	    PARENT: ["genericEggnought"],
	    LABEL: "Converter",
	    TURRETS: [], 
	}
	for (let i = 0; i < 2; i++) {
		Class.converterOfficialV2.TURRETS.push(
			{
				POSITION: [11, 8.5, 0, 180*i, 190, 0],
				TYPE: ["converterTurretOfficialV2"]
			},
		)
	}
	Class.converter2OfficialV2 = {
		PARENT: "converterOfficialV2",
		BATCH_UPGRADES: true,
	}
		...
		GUNS: [
			{
				...
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.basic, g.auto, {speed: 1.1}]),
					TYPE: "bullet",
                                        AUTOFIRE: true,
				},
			},
	...
	Class.popperOfficialV2 = {
	    PARENT: ["genericSquarenought"],
	    LABEL: "Popper",
	    GUNS: [],
	}
	for (let i = 0; i < 4; i++) {
		Class.popperOfficialV2.GUNS.push(
			{
				POSITION: [19, 7, 1, 0, 0, 90*i, 0],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.mini, {reload: 1.1, density: 1/2}]),
					TYPE: "bullet",
				},
			},
			{
				POSITION: [17, 7, 1, 0, 0, 90*i, 0.333],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.mini, {reload: 1.1, density: 1/2}]),
					TYPE: "bullet",
				},
			...
			{
				POSITION: [15, 7, 1, 0, 0, 90*i, 0.667],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.mini, {reload: 1.1, density: 1/2}]),
					TYPE: "bullet",
				},
	...
	Class.flintOfficialV2 = {
	    PARENT: ["genericSquarenought"],
	    LABEL: "Flint",
	    GUNS: [],
	}
	for (let i = 0; i < 4; i++) {
		Class.flintOfficialV2.GUNS.push(
			{
				POSITION: [18, 7, 1, 0, 0, 90*i, 0],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.hunter, {reload: 1.1, density: 1/2}]),
					TYPE: "bullet",
				},
			},
			{
				POSITION: [16, 10, 1, 0, 0, 90*i, 0.15],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.hunter, {reload: 1.1, density: 1/2}]),
					TYPE: "bullet",
				},
	...
	for (let i = 0; i < 4; i++) {
		Class.melderOfficialV2.GUNS.push(
			{
		...
		Class.melderOfficialV2.TURRETS.push(
			{
				POSITION: [7, 10, 0, 45+90*i, 190, 0],
				TYPE: "converterTurretOfficialV2"
			},
		)
	}

	Class.windOfficialV2 = {
	    PARENT: ["genericSquarenought"],
	    LABEL: "Wind",
	    TURRETS: [],
	}
	for (let i = 0; i < 4; i++) {
		Class.windOfficialV2.TURRETS.push(
			{
				POSITION: [7, 8.5, 4, 90*i, 140, 0],
				TYPE: "converterTurretOfficialV2"
			},
			{
				POSITION: [7, 8.5, -4, 90*i, 140, 0],
    ...
    },
    {
      POSITION: [12, 11, 1, 0, 0, i*120, 0],
		...
		Class.dissolverOfficialV2.TURRETS.push(
			{
				POSITION: [9, 9.5, 0, 60+120*i, 190, 0],
				TYPE: "converterTurretOfficialV2"
			},
		)
	}
    ...
    },
    {
      POSITION: [5.5, 7, -1.8, 6.5, 0, 72*i, 0],
		...
		Class.stellaratorOfficialV2.TURRETS.push(
			{
				POSITION: [8, 8.5, 0, 36+72*i, 190, 0],
				TYPE: "converterTurretOfficialV2"
			},
		)
	}
	...
	Class.addons.UPGRADES_TIER_0.push("dreadOfficialV2");
		Class.dreadOfficialV2.UPGRADES_TIER_0 = [
			...
			["converter2OfficialV2", "dreadBodyOfficialV2"],
		];
		...
		Class.converter2OfficialV2.UPGRADES_TIER_0 = ["converterOfficialV2"];

		Class.dreadWeaponOfficialV2.UPGRADES_TIER_0 = ["swordOfficialV2", "pacifierOfficialV2", "peacekeeperOfficialV2", "invaderOfficialV2", "centaurOfficialV2", "converterOfficialV2"];

			Class.swordOfficialV2.UPGRADES_TIER_0 = ["gladiusOfficialV2", "sabreOfficialV2", "popperOfficialV2", "flintOfficialV2"];
